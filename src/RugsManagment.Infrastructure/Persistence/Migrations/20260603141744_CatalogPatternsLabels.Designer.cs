...
namespace RugsManagment.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260603141744_CatalogPatternsLabels")]
    partial class CatalogPatternsLabels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RugsManagment.Domain.Entities.RugPattern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RugsManagment.Domain.Entities.ProcessStepType", b =>
                {
                    b.HasOne("RugsManagment.Domain.Entities.Tenant", null)
                        .WithMany()
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("RugsManagment.Domain.Entities.Rug", b =>
                {
                    b.HasOne("RugsManagment.Domain.Entities.RugPattern", "PatternRef")
                        .WithMany()
